...
<template>
    <form class="flex-1 flex flex-col justify-center items-center gap-6 w-full" @submit.prevent="signupAndIn">
        <h3 class="text-2xl text-white font-semibold" v-if="useTitle">
        ...
        <InputField input-id="confirm-password" input-name="confirm-password" input-type="password"
            :input-errors="v$.confirmPassword.$errors" v-model="v$.confirmPassword.$model" label-text="Confirm Password"
